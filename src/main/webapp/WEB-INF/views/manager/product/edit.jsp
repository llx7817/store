...
<!-- 						图片上传 -->
<!-- 						<div class="input-title-position"> -->
<!-- 								  <label for="product_ico"><span class="thick label-name">产品图</span></label> -->
<!-- 								  <div class="my-no-br-right" > -->
<!-- 								  用来存放item   -->
...
<!-- 						</div>  -->
						<div class="input-title-position">
							  ...
							  <div class="my-no-br-right" >
							  			       		<form:select class="form-control " style="width:280px;"  path="productParameter.id" items="${productParameterList }" itemLabel="name" itemValue="id"></form:select>
