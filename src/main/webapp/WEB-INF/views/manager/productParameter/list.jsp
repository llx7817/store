...
<body>
	<div class="main-body-position">
		...
		<h4 class="my-list-header">商品参数列表</h4>
			...
			<div class="modal-dialog">
				<div class="modal-content" style="width: 65%;height: 211px;">
						...
						<div class="text-center" style="  padding-top: 11%;">
								  <label for="productParameter_name"><span class="thick label-name">名称</span></label>
...
<script type="text/javascript" src="${contextPath}/resources/js/manager/productParameter/list.js"></script>
