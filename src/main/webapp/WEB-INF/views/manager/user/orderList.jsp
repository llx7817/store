...
<!-- 				<div class="mydiv gray-background" >商品列表</div>  -->
				<h4 class="my-list-header"  userid=" ${item.id}" id="user">  ${item.name} &nbsp;用户订单列表</h4>
				<br>
				<!-- 					这是列表 -->
...
<script type="text/javascript" src="${contextPath}/resources/js/manager/user/orderList.js"></script>
