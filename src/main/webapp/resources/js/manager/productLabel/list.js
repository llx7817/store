//var ClassName=""
var searchUrl =contextPath + "/manager/productLabel/load/search.do";
var delUrl =contextPath + "/manager/productLabel/load/delete.do";
var saveUrl =contextPath + "/manager/productLabel/load/save.do";
var editUrl =contextPath + "/manager/productLabel/edit.do";
var listUrl =contextPath + "/manager/productLabel/list.do";
